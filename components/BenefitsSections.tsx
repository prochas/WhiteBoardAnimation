    ...
    <div className="max-w-[1380px] mx-auto pl-[30px] pr-[30px] pb-[100px]">
      ...
      <div className="flex flex-col gap-[100px]">
        ...
        <div className="flex items-center gap-[150px]">
          <div className="flex items-center justify-center w-full max-w-[541px] min-h-[506px] rounded-[24px] px-[20px] py-[40px] bg-gradient-to-b from-[#f99079] via-[#fcc7be] via-[42.8%] to-white">
            <Image
          ...
          <div className="flex flex-col items-start w-full max-w-[648px] gap-[48px]">
            <div className="flex flex-col items-start gap-[25px]">
              ...
              <div className="flex flex-col gap-[16px]">
                <h2 className="max-w-[510px] text-[40px] font-medium leading-[130%] text-[#11122c]">
                  Boosted Conversions
                </h2>
        ...
        <div className="flex items-center gap-[150px]">
          ...
          <div className="flex items-center justify-center w-full max-w-[541px] min-h-[506px] rounded-[24px] px-[20px] py-[40px] bg-[linear-gradient(143.89deg,_#fff6,_#fff0_67.37%),linear-gradient(#f976b5,_#fa89bf_0%,_#fff_100%,_#fff)]">
            <Image
        ...
        {/* Visual Storytelling */}
        <div className="flex items-center gap-[150px]">
          <div className="flex items-center justify-center w-full max-w-[541px] min-h-[506px] rounded-[24px] px-[20px] py-[40px] bg-[linear-gradient(143.89deg,_#fff6,_#fff0_67.37%),linear-gradient(#7976f9,_#fff)]">
            <Image
